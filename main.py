...
bot_token = environ.get("TOKEN", "5c") 
api_hash = environ.get("HASH", "35") 
api_id = int(environ.get("ID", "22"))
bot = Client("mybot", api_id=api_id, api_hash=api_hash, bot_token=bot_token)

ss = environ.get("STRING", "BAFgLYIAPwR4PaVQEdVWrAyJ-e_HyCn1Twe-4El3RQ-sh7rFxIfSM5G8zZEKDph_DXTkstu1JFB7QAAAAGCggAWAA")
if ss is not None:
